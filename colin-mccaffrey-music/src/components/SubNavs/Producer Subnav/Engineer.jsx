...
function Engineer() {
  ...
  const meta = {
    ...
    description: "Colin McCaffrey is an award-winning Vermont producer and recording engineer. Here you can find details about his studio and equipment.",
    ...
    meta: {
      ...
      property: {
        ...
        "og:description": "Colin McCaffrey is an award-winning Vermont producer and recording engineer. Here you can find details about his studio and equipment.",
